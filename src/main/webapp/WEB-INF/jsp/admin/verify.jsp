...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
				...
				<div class="navbar-default sidebar" role="navigation">
					<div class="sidebar-nav navbar-collapse">
						<ul class="nav" id="side-menu">
							...
							<li><a href="${pageContext.request.contextPath}/Averify" class="active"><i class="fa fa-edit fa-fw"></i> 审核报名</a></li>
			...
			<div id="page-wrapper">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form class="form-inline" action="${pageContext.request.contextPath }/Averify" method="post">
									...
									<tbody class="text-center">
										<c:forEach items="${studentList}" var="item">
											<tr>
												...
												<td>${item.kemu}</td>
												<td>
													<a href="#" class="btn btn-primary btn-xs" onclick="updateStatusToThree(${item.id})">通过</a>
													<a href="#" class="btn btn-danger btn-xs" onclick="updateStatusToFour(${item.id})">不通过</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
		...
		<script type="text/javascript">
			function updateStatusToThree(id){
				$.post("<%=basePath%>admin/updateStatusToThree",{"id":id},function(data){
					window.location.reload();
				});
			}
			
			function updateStatusToFour(id){
				$.post("<%=basePath%>admin/updateStatusToFour",{"id":id},function(data){
					window.location.reload();
				});
			}
